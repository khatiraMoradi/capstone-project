...
public class SignInSteps extends CommonUtility{
	...
	public void userClickOnSignInOption(){
		...
		logger.info("User click on signin Option");
		
	}
	@When("user enter email {string} and password {string}")
	public void userInterEmailAndPassword(String emailValue,String PasswordValue){
		sendText(factory.signInPage().emailField, emailValue);
		sendText(factory.signInPage().passwordField, PasswordValue);
		logger.info("user inter email" + emailValue + "and password" + PasswordValue);
	}
